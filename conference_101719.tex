...
\begin{IEEEkeywords}
    graph, embedding, community embedding, recommendations, friend suggestions
\end{IEEEkeywords}
...
This work specifically examines community embeddings for friend suggestion recommender systems and evaluates recommendations on social network graph data for the use-case of friend suggestions. Graph and community embeddings generated with ComE BGMM+VI are used to develop a friend suggestions recommender system. Recommendations are evaluated by the top-$N$ recommendations hit-rate of test edges. A friend suggestions recommender system with a top-$10$ leave-one-out hit-rate of over $40\%$ is reached.
